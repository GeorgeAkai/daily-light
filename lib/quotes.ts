...
const motivationalQuotes: string[] = [
  ...
  "God's timing is never early, never late — always perfect.",
  ...
  "Bloom with patience — even the lily takes its season.",
  ...
  "Broken crayons still color — your story still matters.",
  ...
  "Do not despise small beginnings — mustard seeds move mountains.",
