// Verse text from the World English Bible (WEB), a public domain translation.
...
export const verses: Verse[] = [
  ...
  },
  {
    ...
    text: "Rejoice in hope, endure in troubles, continue steadfastly in prayer.",
    theme: "Perseverance",
  },
  {
  ...
  },
  {
    ...
    text: "Enter into his gates with thanksgiving, and into his courts with praise. Give thanks to him, and bless his name. For Yahweh is good. His loving kindness endures forever, his faithfulness to all generations.",
    theme: "Gratitude",
  },
  {
  ...
  },
  {
    ...
    text: "My soul rests in God alone. My salvation is from him. He alone is my rock, my salvation, and my fortress. I will never be greatly shaken.",
    theme: "Rest",
  },
  {
    reference: "Isaiah 54:17",
    text: "No weapon that is formed against you will prevail; and you will condemn every tongue that rises against you in judgment.",
    theme: "Protection",
  },
  {
  ...
  },
  {
    ...
    text: "A man's steps are established by Yahweh. He delights in his way. Though he stumble, he will not fall, for Yahweh holds him up with his hand.",
    theme: "Guidance",
  },
  {
