...
export default function QuizPage() {
  ...
  const reshuffle = () => {
    setCards(shuffleCards(quizCards));
    setFlipped(new Set());
  };
    ...
    <div className="space-y-8">
      <section className="text-center">
        ...
        <p className="mx-auto mt-2 max-w-xl text-muted">
          Tap a card to reveal the answer. How many can you get right?
        </p>
      </section>
